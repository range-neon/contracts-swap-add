...
async function main() {
    ...
    // const mintApprove = await token0Ctx.approve(multicallAddress, ethers.utils.parseEther("0.00084"))
    // const swap = await multicallCtx.swapAdd(encodedData, ethers.utils.parseEther("0.00084"),{gasLimit: 5000000 })
    // console.log(swap)
